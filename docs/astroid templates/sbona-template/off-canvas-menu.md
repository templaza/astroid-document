...
![sbona-offcanvas-menu.png](img/sbona-offcanvas-menu.png)
...
Go to Content > Site Modules > New. Create a New module.
...
You can create a new offcanvas module or edit the ready-made custom module named **About Sbona**.

![sbona-offcanvas-module.png](img/sbona-offcanvas-module.png)
