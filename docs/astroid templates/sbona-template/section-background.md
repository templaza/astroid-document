...
Layout Builder allows you to create visually engaging website sections using colors, images, videos, overlays, gradients, spacing, and animation effects. It is one of the most important design tools for building modern Joomla websites without coding. ([Astroid Framework][1])

---

# Accessing Section Background Settings
